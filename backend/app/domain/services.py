...
SUSPICIOUS_KEYWORDS = [
    "teen", "girl", "boy", "young", "minor", "link in bio", "subscribe", "pay"
]
SUSPICIOUS_EMOJI = ["🔥", "💦", "🔞", "🔒"]

def compute_risk_and_reasons(metadata: AccountMetadata) -> (RiskScore, List[str]):
    reasons = []
    score = 0.0
